...
void main() {
  ...
  final fragen = [
    ...
    },
    {
      ...
      'option_a': 'Ein wöchentliches Team meting',
    ...
    },
    {
      ...
      'correct_answer': 'B',
      'explanation': 'Ein Sprint ist ein Zeitrahmen (Timebox) von 1–4 Wochen in dem das Scrum-Team ein fertiges, auslieferbares Produktinkrement erstellt. Am Ende steht immer ein Sprint Review und eine Retrospektive.',
    },
    {
      'category': 'PQSM',
      'difficulty': 'schwer',
