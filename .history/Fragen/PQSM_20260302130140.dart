...
void main() {
  ...
  final fragen = [
    ...
    },
    {
      ...
      'correct_answer': 'B',
      'explanation': 'Ein Sprint ist ein Zeitrahmen (Time Box) von 1–4 Wochen in dem das Scrum-Team ein fertiges, Auslieferbar Produktinkrement erstellt. Am Ende steht immer ein Sprint Review und eine Retrospektive.',
    },
    {
      'category': 'PQSM',
      'difficulty': 'schwer',
