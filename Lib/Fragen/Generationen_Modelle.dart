const List<Map<String, String>> fragenComputergenerationen = [
  ...
  },
  {
    ...
    'option_a': 'Transistoren → Vakuumröhren → ICs → Mikroprozessoren',
    'option_b': 'ICs → Transistoren → Vakuumröhren → Mikroprozessoren',
    'option_c': 'Vakuumröhren → Transistoren → ICs → Mikroprozessoren',
    'option_d': 'Mikroprozessoren → ICs → Transistoren → Vakuumröhren',
    'correct_answer': 'C',
